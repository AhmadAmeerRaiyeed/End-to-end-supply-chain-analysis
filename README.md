...
We use Python libraries such as Pandas, Matplotlib, Seaborn, and Scikit-learn to extract insights and build a predictive model that identifies high-risk products in the supply chain.
...
🔗 https://drive.google.com/file/d/1p4HFzPXoUKlcn0nkYBKA4khAW07rOYi3/view?usp=sharing
...
3️⃣ Run the Project
jupyter notebook
Open and run: 👉 end_to_end_supply_chain.ipynb
